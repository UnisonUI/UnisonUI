...
object HelloRequest
  ...
  implicit def messageCompanion
      : scalapb.GeneratedMessageCompanion[com.example.helloworld.HelloRequest] =
    this
  def merge(`_message__`: com.example.helloworld.HelloRequest,
  ...
  implicit def messageReads
      : _root_.scalapb.descriptors.Reads[com.example.helloworld.HelloRequest] =
  ...
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    HelloworldProto.scalaDescriptor.messages(0)
  ...
  implicit class HelloRequestLens[UpperPB](
      ...
      extends _root_.scalapb.lenses.ObjectLens[
        UpperPB,
        com.example.helloworld.HelloRequest](_l) {
  ...
  def of(
      name: _root_.scala.Predef.String
  ): _root_.com.example.helloworld.HelloRequest =
    _root_.com.example.helloworld.HelloRequest(
      name
    )
