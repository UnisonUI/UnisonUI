...
final case class HelloReply(
  ...
  private[this] def __computeSerializedValue(): _root_.scala.Int = {
...

    {
      val __value = message
      if (!__value.isEmpty) {
        __size += _root_.com.google.protobuf.CodedOutputStream
          .computeStringSize(1, __value)
      }
    };
  ...
  def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream)
      : _root_.scala.Unit = {
    {
      val __v = message
      if (!__v.isEmpty) {
  ...
  def withMessage(__v: _root_.scala.Predef.String): HelloReply =
    copy(message = __v)
  ...
  def getField(__field: _root_.scalapb.descriptors.FieldDescriptor)
...
object HelloReply
  ...
  implicit def messageCompanion
      : scalapb.GeneratedMessageCompanion[com.example.helloworld.HelloReply] =
    this
  def merge(`_message__`: com.example.helloworld.HelloReply,
    ...
    com.example.helloworld.HelloReply(
      message = __message,
      unknownFields =
        if (_unknownFields__ == null) _message__.unknownFields
        else _unknownFields__.result()
    )
  }
  implicit def messageReads
      : _root_.scalapb.descriptors.Reads[com.example.helloworld.HelloReply] =
  ...
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor =
    HelloworldProto.scalaDescriptor.messages(1)
  def messageCompanionForFieldNumber(
      __number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] =
    throw new MatchError(__number)
  lazy val nestedMessagesCompanions
      : Seq[_root_.scalapb.GeneratedMessageCompanion[
        _ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  ...
  implicit class HelloReplyLens[UpperPB](
      _l: _root_.scalapb.lenses.Lens[UpperPB,
                                     com.example.helloworld.HelloReply])
      extends _root_.scalapb.lenses.ObjectLens[
        UpperPB,
        com.example.helloworld.HelloReply](_l) {
    def message
        : _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] =
      field(_.message)((c_, f_) => c_.copy(message = f_))
  }
  final val MESSAGE_FIELD_NUMBER = 1
  def of(
      message: _root_.scala.Predef.String
  ): _root_.com.example.helloworld.HelloReply =
    _root_.com.example.helloworld.HelloReply(
      message
    )
